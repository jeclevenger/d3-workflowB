$( document ).ready(function () {
    ...
    $(document).on("click", ":submit", function(event){
        loadData($("select#datasetSelector").val(),$(this).val(),$("select#xaxisSelector").val(),$("select#yaxisSelector").val());
        event.preventDefault();
    });

    //////////////////////////////////////d3
    function loadData(datafilename,loadtype,xaxis,yaxis) {
        ...
        // Get the data
        //todo error handling, bad data, bad args
